...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE barang SET nama_barang = ?, ukuran = ?, jumlah_barang = ?, gambar = ? WHERE ID_barang = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("ssiss", $nama_barang, $ukuran, $jumlah_barang, $fileName, $id_barang);
