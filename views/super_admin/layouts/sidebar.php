            ...
            <li class="dropdown header-profile">
                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                    ...
                    <div class="header-info ms-3">
                        <span class="font-w600"><b id="namaSuperAdmin"></b></span>
                        <small class="text-end font-w400" id="emailSuperAdmin"></small>
                    </div>
                </a>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        fetch("backend/get_super_admin")
            .then(response => response.json())
            .then(data => {
                if (!data.error) {
                    document.getElementById("namaSuperAdmin").innerText = data.nama_admin_utama;
                    document.getElementById("emailSuperAdmin").innerText = data.email_admin_utama;
                } else {
