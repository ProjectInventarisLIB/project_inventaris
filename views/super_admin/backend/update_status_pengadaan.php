...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update status surat
    $query = "UPDATE surat_pengadaan SET status = ? WHERE no_surat = ?";
    ...
    if ($stmt->execute()) {
        ...
        $pdfFile = $_SERVER['DOCUMENT_ROOT'] . "/project_inventaris/upload/surat_pengadaan/surat_pengadaan_" . str_replace("/", "-", $no_surat) . ".pdf";
        ...
        $updatedPdfPath = $_SERVER['DOCUMENT_ROOT'] . "/project_inventaris/upload/surat_pengadaan/surat_pengadaan_" . str_replace("/", "-", $no_surat) . ".pdf";
